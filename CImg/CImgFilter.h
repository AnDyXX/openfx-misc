...
<<<<<<< HEAD
	...
	{
			assert(!mask || ((mask->getPixelComponents() == OFX::ePixelComponentAlpha || mask->getPixelComponents() == OFX::ePixelComponentRGBA) && mask->getPixelDepth() == OFX::eBitDepthFloat));
...
>>>>>>> 12fae007ed5836d5d26bde5db1af07a82f4062de
